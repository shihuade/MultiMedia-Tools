...
runInit()
{
    ...
    x264Arg01=" -x264opts scenecut=30:subme=0:trellis=0 -bf 2 -refs 2 "
    x264Arg02=" -x264opts scenecut=30:subme=0:trellis=0:threads=1 -bf 2 -refs 2 "
    x264Param=" -rc-lookahead 10 -crf 22 -qcomp 0.54 -deblock 0 -nr 450"
    PluseParam=" -movflags faststart -use_editlist 0 -y"
